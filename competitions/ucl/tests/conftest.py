...
_REAL_TEAMS_POT1 = [
    "PSG", "Real Madrid", "Man City", "Bayern", "Liverpool",
    "Inter", "Chelsea", "Dortmund", "Barcelona",
]
_REAL_TEAMS_POT2 = [
    "Arsenal", "Bayer Leverkusen", "Atletico Madrid", "Benfica",
    "Atalanta", "Villarreal", "Juventus", "Eintracht Frankfurt", "Club Brugge",
]
_REAL_TEAMS_POT3 = [
    "Tottenham", "PSV", "Ajax", "Napoli", "Sporting",
    "Olympiacos", "Slavia Prague", "Bodo/Glimt", "Marseille",
]
_REAL_TEAMS_POT4 = [
    "Copenhagen", "Monaco", "Galatasaray", "Union SG", "Qarabag",
    "Athletic Bilbao", "Newcastle", "Pafos", "Kairat",
]
...
_UEFA_COEFFICIENTS = {
    ...
    "Barcelona": 103.25,
    "Arsenal": 98.0,
    "Bayer Leverkusen": 95.25,
    "Atletico Madrid": 93.5,
    "Benfica": 87.75,
    "Atalanta": 82.0,
    "Villarreal": 82.0,
    "Juventus": 74.25,
    "Eintracht Frankfurt": 74.0,
    "Club Brugge": 71.75,
    "Tottenham": 70.25,
    "PSV": 69.25,
    "Ajax": 67.25,
...
_SUB_POT3 = ["PSV", "Olympiacos", "Sporting", "Tottenham"]
_SUB_POT4 = ["Monaco", "Copenhagen", "Galatasaray", "Athletic Bilbao"]
