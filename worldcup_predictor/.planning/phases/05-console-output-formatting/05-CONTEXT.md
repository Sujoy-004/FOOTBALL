...
- **D-03:** Top 5 teams by championship probability, showing QF/SF/FINAL/CHAMPION columns with inline delta per row. Followed by a one-liner summarizing remaining teams:
  ```
...
- **D-04:** In addition to the inline delta in the Top-5 table, show a separate Biggest Risers / Biggest Fallers section (top 3 each) with champion% deltas. Not all 32 teams and not threshold-based:
  ```
  Biggest Risers
    ▲ Argentina   +3.2%
    ▲ Brazil      +1.8%
